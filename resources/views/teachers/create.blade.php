...
@section('title', 'เพิ่มข้อมูลคุณครู')
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="d-flex align-items-center mb-4">
                    <a href="{{ route('teachers.index') }}" class="btn btn-link text-decoration-none text-muted p-0 me-3">
                        <i class="fas fa-arrow-left fa-lg"></i>
                    </a>
                    <h2 class="fw-bold text-dark mb-0">เพิ่มข้อมูลคุณครูใหม่</h2>
                </div>
                        ...
                        <form action="{{ route('teachers.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="text-center mb-5">
                                <div class="position-relative d-inline-block">
                                    ...
                                    <label for="image"
                                        class="position-absolute bottom-0 end-0 btn btn-primary btn-sm rounded-circle shadow"
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text"
                                            ...
                                            placeholder="ตัวอย่าง: อ.สมชาย ใจดี" required>
                                    </div>
                                    @error('name')
                                ...
                                <div class="col-12 mt-5">
                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                        <a href="{{ route('teachers.index') }}"
                                            class="btn btn-light btn-lg rounded-pill px-4 me-md-2">ยกเลิก</a>
                                        <button type="submit" class="btn btn-primary btn-lg rounded-pill px-5 shadow-sm">
                                            <i class="fas fa-save me-2"></i> บันทึกข้อมูลครู
                                        </button>
                                    </div>
                                </div>
                            </div>
