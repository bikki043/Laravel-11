    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <a href="{{ route('students.index') }}" class="text-decoration-none text-muted">
                    <i class="fas fa-arrow-left me-1"></i> ย้อนกลับ
                </a>
                <a href="{{ route('students.edit', $student->id) }}" class="btn btn-warning btn-sm rounded-pill px-4 text-white shadow-sm">
                    ...
                    <div class="row g-0">
                        <div class="col-md-5 bg-light text-center p-5 border-end">
                            <div class="mb-4">
                                ...
                                @else
                                    <img src="https://ui-avatars.com/api/?name={{ urlencode($student->name) }}&background=6366f1&color=fff&size=180" 
                                         class="rounded-circle shadow-sm border border-4 border-white">
                                @endif
                            </div>
                            <h4 class="fw-bold text-dark mb-1">{{ $student->name }}</h4>
                            <span class="badge bg-primary-subtle text-primary rounded-pill px-3">นักเรียน (Student)</span>
                            <div class="mt-3 text-muted small">
                                <strong>ID:</strong> #{{ str_pad($student->id, 5, '0', STR_PAD_LEFT) }}
                            </div>
                        </div>
                        ...
                        <div class="col-md-7 p-5">
                            ...
                            <div class="d-flex align-items-center mb-4">
                                ...
                                <div>
                                    ...
                                    <span class="h6 mb-0">{{ $student->email }}</span>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-center mb-4">
                                ...
                                <div>
                                    ...
                                    <span class="h6 mb-0">{{ $student->created_at->isoFormat('D MMMM YYYY') }}</span>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-center mb-0">
                                ...
                                <div>
                                    ...
                                    <span class="h6 mb-0">{{ $student->updated_at->diffForHumans() }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <p class="text-center text-muted mt-4 small">
                <i class="fas fa-lock me-1"></i> ข้อมูลนี้ถูกจัดการผ่านระบบฐานข้อมูลนักเรียน
            </p>
        </div>
    </div>
</div>
